...
btn_minus=tk.Button(window,text="-",command=lambda: add_to_field("-"),width=5,font=("New Times Roman",14))
btn_minus.grid(row=5,column=4)

btn_times=tk.Button(window,text="*",command=lambda: add_to_field("*"),width=5,font=("New Times Roman",14))
btn_times.grid(row=3,column=4)

btn_division=tk.Button(window,text="/",command=lambda: add_to_field("/"),width=5,font=("New Times Roman",14))
...
btn_decimal=tk.Button(window,text=".",command=lambda: add_to_field("."),width=5,font=("New Times Roman",14))
btn_decimal.grid(row=5,column=2)

btn_open_parenthesis=tk.Button(window,text="(",command=lambda: add_to_field("("),width=5,font=("New Times Roman",14))
btn_open_parenthesis.grid(row=6,column=1)

btn_close_parenthesis=tk.Button(window,text=")",command=lambda: add_to_field(")"),width=5,font=("New Times Roman",14))
btn_close_parenthesis.grid(row=6,column=2)

btn_summary=tk.Button(window,text="=",command=lambda: calculate(),width=13,font=("New Times Roman",14))
btn_summary.grid(row=6,column=3,columnspan=2)
